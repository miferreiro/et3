...
function permisosAcc($login,$funcionalidad,$accion){
	   $mysqli=ConectarBD();
	   $sql = "SELECT DISTINCT U.login, P.IdGrupo, P.IdFuncionalidad FROM PERMISO P, USU_GRUPO U WHERE U.login = '$login' && (U.IdGrupo = '00000A' || (U.IdGrupo = P.IdGrupo && P.IdFuncionalidad = '$funcionalidad' && P.IdAccion = '$accion') )";
