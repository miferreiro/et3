			...
			<form name="EDIT" action="../Controllers/USUARIOS_CONTROLLER.php" method="post" enctype="multipart/form-data" onsubmit="return comprobarEdit()">
				<table>
					...
					<tr>
						...
						<td class="formThTd"><input type="text" id="idgroup" name="idgroup" placeholder="<?php echo $strings['Escriba aqui...']?>" value="<?php echo $this->valores['ID Grupo']?>" maxlength="9" size="11" onBlur="comprobarVacio(this) && comprobarLongitud(this,'9') && comprobarTexto(this,'9')" required/>
					</tr>
