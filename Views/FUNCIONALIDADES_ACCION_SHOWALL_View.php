<?php
/*  Archivo php
	Nombre: FUNCIONALIDADES_ACCION_SHOWALL_View.php
...
*/
class FUNCIONALIDADES_ACCION_SHOWALL {
		...
		<div class="seccion">
			...
			<table>
				<caption style="margin-bottom:10px;">
					<form action='../Controllers/FUNCIONALIDADES_ACCION_CONTROLLER.php'>
...
?>
					<td>
						<form action="../Controllers/FUNCIONALIDADES_ACCION_CONTROLLER.php" method="get" style="display:inline" >
