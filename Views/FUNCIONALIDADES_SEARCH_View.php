<?php
/*  Archivo php
	Nombre: FUNCIONALIDADES_SEARCH_View.php
...
?>
		<div class="seccion">
			...
			<form id="SEARCH" action="../Controllers/FUNCIONALIDADES_CONTROLLER.php" method="post" enctype="multipart/form-data" onsubmit="return comprobarSearch()">
				<table>
					<tr>
						<th class="formThTd">
					...
					<tr>
						...
						<td class="formThTd"><input type="text" id="nombreFunc" name="nombreFunc" placeholder="<?php echo $strings['Escriba aqui...']?>" value="" maxlength="30" size="34" onBlur="comprobarLongitud(this,'30') && comprobarTexto(this,'30') && comprobarAlfabetico(this,'30')"/>
					</tr>
					<tr>
						<th class="formThTd">
							<?php echo $strings['Descripción Funcionalidad'];?>
						</th>
						<td class="formThTd"><input type="text" id="descripFunc" name="descripFunc" placeholder="<?php echo $strings['Escriba aqui...']?>" value="" maxlength="50" size="60" onBlur="comprobarLongitud(this,'50') && comprobarTexto(this,'50') && comprobarAlfabetico(this,'50')"/>
					</tr>
