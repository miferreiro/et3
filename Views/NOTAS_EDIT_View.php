...
class NOTAS_EDIT {
	...
	function render($valores) {
		...
		<div class="seccion">
			...
			<form name="EDIT" action="../Controllers/NOTAS_CONTROLLER.php" method="post" enctype="multipart/form-data">
				<table>
					<tr>
						<th class="formThTd">
							<?php echo $strings['Usuario'];?>
						</th>
						<td class="formThTd"><input type="text" id="login" name="login" placeholder="<?php echo $strings['Escriba aqui...']?>" value="<?php echo $this->valores['login']?>" maxlength="9" size="9"  readonly onBlur="comprobarVacio(this) && sinEspacio(this) && comprobarLongitud(this,'9') && comprobarTexto(this,'9')" required/>
					</tr>
					<tr>
						<th class="formThTd">
					...
					<tr>
						...
						<td class="formThTd"><input type="text" id="NotaTrabajo" name="NotaTrabajo" placeholder="<?php echo $strings['Escriba aqui...']?>" value="<?php echo $this->valores['NotaTrabajo']?>" maxlength="4" size="4" onBlur="comprobarVacio(this) && comprobarLongitud(this,'9') " required/>
					</tr>
