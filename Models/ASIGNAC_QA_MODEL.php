...
class ASIGNAC_QA_MODEL{ //declaración de la clase
	...
	function ADD() {
		if ( ( $this->IdTrabajo <> '' && $this->LoginEvaluador <> '' && $this->LoginEvaluado <> '' && $this->AliasEvaluado <> '' ) ) { 
            
			// construimos el sql para buscar esa clave en la tabla
			$sql = "SELECT * FROM EVALUACION WHERE (  IdTrabajo = '$this->IdTrabajo' && LoginEvaluador = '$this->LoginEvaluador' && LoginEvaluado = '$this->LoginEvaluado' && AliasEvaluado = '$this->AliasEvaluado')";
	...
	function DELETE() {
		...
		$sql = "SELECT * FROM ASIGNAC_QA WHERE (IdTrabajo = '$this->IdTrabajo' && LoginEvaluador = '$this->LoginEvaluador' && LoginEvaluado = '$this->LoginEvaluado' && AliasEvaluado = '$this->AliasEvaluado')";
		// se ejecuta la query
		...
		if ( $result->num_rows == 1 ) {
			...
			$sql = "DELETE FROM ASIGNAC_QA WHERE (IdTrabajo = '$this->IdTrabajo' && LoginEvaluador = '$this->LoginEvaluador' && LoginEvaluado = '$this->LoginEvaluado' && AliasEvaluado = '$this->AliasEvaluado')";
			// se ejecuta la query
			$this->mysqli->query( $sql );
